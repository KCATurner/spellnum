"""
Unit tests for spellnum.functions.number2text function.
"""
...
class InputValidity(unittest.TestCase):
    ...
    def test_input_EQ_minimum(self):
        ...
        actual = spellnum.functions.number2text('-9.99e3002')
    ...
    def test_precision_EQ_maximum(self):
        ...
        actual = spellnum.functions.number2text('1e-3002')
        self.assertMultiLineEqual(expected, actual)
    
    def test_input_none(self):
        self.assertRaises(ValueError, spellnum.functions.number2text, None)
    
    def test_input_set(self):
        self.assertRaises(ValueError, spellnum.functions.number2text, {123, })
    ...
    def test_string_dXXX(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('.123'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-.123'))
    ...
    def test_ValidFormat_dXeX(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(.1e9))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('.1e9'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-.1e9))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-.1e9'))
    
    def test_ValidFormat_XdXEX(self):
        expected = 'one billion two hundred million'
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(1.2E9))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('1.2E9'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-1.2E9))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-1.2E9'))
    ...
    def test_ValidFormat_XdXenX(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(1.2e-9))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('1.2e-9'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-1.2e-9))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-1.2e-9'))
    
    def test_ValidFormat_0dXeX(self):
        expected = 'one hundred million'
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(0.1e9))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('0.1e9'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-0.1e9))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-0.1e9'))
    
    def test_ValidFormat_Xd0eX(self):
        expected = 'one billion'
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(1.0e9))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('1.0e9'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-1.0e9))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-1.0e9'))
    ...
    def test_ValidFormat_XXXdXXXeXXX(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(123.456e123))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('123.456e123'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-123.456e123))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-123.456e123'))
    
    def test_ValidFormat_0XXdXX0e0XX(self):
        expected = 'twelve trillion three hundred forty billion'
        self.assertMultiLineEqual(expected, spellnum.functions.number2text(012.340e012))
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('012.340e012'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text(-012.340e012))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-012.340e012'))
    ...
    def test_PrecisionRetention(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.number2text('1.2345678987654321e123'))
        self.assertMultiLineEqual('negative ' + expected, spellnum.functions.number2text('-1.2345678987654321e123'))
    
    def test_InvalidInputs(self):
        self.assertRaises(ValueError, spellnum.functions.number2text, '')
        self.assertRaises(ValueError, spellnum.functions.number2text, '.')
        self.assertRaises(ValueError, spellnum.functions.number2text, 'e')
        self.assertRaises(ValueError, spellnum.functions.number2text, '-')
        self.assertRaises(ValueError, spellnum.functions.number2text, '+')
        self.assertRaises(ValueError, spellnum.functions.number2text, '.e')
        self.assertRaises(ValueError, spellnum.functions.number2text, '.0e')
        self.assertRaises(ValueError, spellnum.functions.number2text, '.0e-')
        self.assertRaises(ValueError, spellnum.functions.number2text, '0.0e')
        self.assertRaises(ValueError, spellnum.functions.number2text, '0.0e-')
        self.assertRaises(ValueError, spellnum.functions.number2text, '0.e-0')
        self.assertRaises(ValueError, spellnum.functions.number2text, '--123')
        self.assertRaises(ValueError, spellnum.functions.number2text, '++123')
        self.assertRaises(ValueError, spellnum.functions.number2text, '-+123')
        self.assertRaises(ValueError, spellnum.functions.number2text, '+-123')
        self.assertRaises(ValueError, spellnum.functions.number2text, '1.2.3')
...
class SpellingExceptions(unittest.TestCase):
    ...
    def test_singular_fraction(self):
        expected = 'one tenth'
        actual = spellnum.functions.number2text(0.1)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_0(self):
        expected = 'zero'
        actual = spellnum.functions.number2text(0)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_0d0(self):
        expected = 'zero'
        actual = spellnum.functions.number2text(0.0)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_0e0(self):
        expected = 'zero'
        actual = spellnum.functions.number2text(0e0)
        self.assertMultiLineEqual(expected, actual)
    ...
    def test_float_0d0e0(self):
        expected = 'zero'
        actual = spellnum.functions.number2text(0.0e0)
        self.assertMultiLineEqual(expected, actual)
    ...
    def test_float_n0en0(self):
        expected = 'zero'
        actual = spellnum.functions.number2text(-0e-0)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_n0d0en0(self):
        expected = 'zero'
        actual = spellnum.functions.number2text(-0.0e-0)
        self.assertMultiLineEqual(expected, actual)
...
class SpellingScientific(unittest.TestCase):
    ...
    def test_float_XXdXXe3(self):
        expected = spellnum.functions.number2text(12340)
        actual = spellnum.functions.number2text(12.34e3)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXe2(self):
        expected = spellnum.functions.number2text(1234)
        actual = spellnum.functions.number2text(12.34e2)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXe1(self):
        expected = spellnum.functions.number2text(123.4)
        actual = spellnum.functions.number2text(12.34e1)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXe0(self):
        expected = spellnum.functions.number2text(12.34)
        actual = spellnum.functions.number2text(12.34e0)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXen0(self):
        expected = spellnum.functions.number2text(12.34)
        actual = spellnum.functions.number2text(12.34e-0)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXen1(self):
        expected = spellnum.functions.number2text(1.234)
        actual = spellnum.functions.number2text(12.34e-1)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXen2(self):
        expected = spellnum.functions.number2text(.1234)
        actual = spellnum.functions.number2text(12.34e-2)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_XXdXXen3(self):
        expected = spellnum.functions.number2text(.01234)
        actual = spellnum.functions.number2text(12.34e-3)
        self.assertMultiLineEqual(expected, actual)
    ...
    def test_float_0d1eXX(self):
        ...
        actual = spellnum.functions.number2text(0.1e64)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_1d0eXX(self):
        expected = 'one vigintillion'
        actual = spellnum.functions.number2text(1.0e63)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_0d1enXX(self):
        expected = 'one one vigintillionth'
        actual = spellnum.functions.number2text(0.1e-62)
        self.assertMultiLineEqual(expected, actual)
    
    def test_float_1d0enXX(self):
        expected = 'one one vigintillionth'
        actual = spellnum.functions.number2text(1.0e-63)
        self.assertMultiLineEqual(expected, actual)
