...
class SpellNumberControl(unittest.TestCase):
    ...
    def test_001000(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(1000))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('1000'))
        
    def test_001111(self):
        expected = 'one thousand one hundred eleven'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(1111))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('1111'))
        
    def test_001Million(self):
        expected = 'one million'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(1000000))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('1000000'))
        
    def test_010Million(self):
        expected = 'ten million'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(10000000))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('10000000'))
        
    def test_100Million(self):
        expected = 'one hundred million'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(100000000))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('100000000'))
...
class SpellNumberFractions(unittest.TestCase):
    ...
    def test_Tenths(self):
        ...
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(10000000.2))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('10000000.2'))
        
    def test_Hundredths(self):
        expected = 'one million and twenty-three one hundredths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(1000000.23))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('1000000.23'))
        
    def test_OneThousandths(self):
        expected = 'one hundred thousand and two hundred three one thousandths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(100000.203))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('100000.203'))
        
    def test_TenThousandths(self):
        expected = 'ten thousand and two thousand three ten thousandths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(10000.2003))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('10000.2003'))
        
    def test_OneHundredThousandths(self):
        expected = 'one thousand and twenty thousand three one hundred thousandths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(1000.20003))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('1000.20003'))
        
    def test_OneMillionths(self):
        expected = 'one hundred and two hundred thousand three one millionths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(100.200003))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('100.200003'))
        
    def test_TenMillionths(self):
        expected = 'ten and two million three ten millionths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(10.2000003))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('10.2000003'))
        
    def test_OneHundredMillionths(self):
        expected = 'one and twenty million three one hundred millionths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(1.20000003))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('1.20000003'))
        
    def test_OneBillionths(self):
        expected = 'two hundred million three one billionths'
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number(.200000003))
        self.assertMultiLineEqual(expected, spellnum.functions.spell_number('.200000003'))
        
    def test_SingularFractions(self):
        self.assertMultiLineEqual('one tenth', spellnum.functions.spell_number(0.1))
        self.assertMultiLineEqual('one tenth', spellnum.functions.spell_number('0.1'))
        self.assertMultiLineEqual('one one hundredth', spellnum.functions.spell_number(0.01))
        self.assertMultiLineEqual('one one hundredth', spellnum.functions.spell_number('0.01'))
        self.assertMultiLineEqual('one ten quadragintillionth', spellnum.functions.spell_number(0.1e-123))
        self.assertMultiLineEqual('one ten quadragintillionth', spellnum.functions.spell_number('0.1e-123'))
