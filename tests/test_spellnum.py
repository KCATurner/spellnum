...
class SuffixInputValidity(unittest.TestCase):
    ...
    def test_input_EQ_minimum(self):
        expected = ''
        self.assertMultiLineEqual(expected, spellnum.__functions.get_period_suffix(-1))
        self.assertMultiLineEqual(expected, spellnum.__functions.get_period_suffix('-1'))
        
    def test_input_EQ_maximum(self):
        expected = 'novenonagintanongentillion'
        self.assertMultiLineEqual(expected, spellnum.__functions.get_period_suffix(999))
        self.assertMultiLineEqual(expected, spellnum.__functions.get_period_suffix('999'))
        
    def test_input_LT_minimum(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, -2)
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, '-2')
        
    def test_input_GT_maximum(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, 1000)
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, '1000')
        
    def test_input_none(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, None)
        
    def test_input_float(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, 12.34)
        
    def test_input_string(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, '12.34')
        
    def test_input_set(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, set())
        
    def test_input_list(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, list())
        
    def test_input_tuple(self):
        self.assertRaises(ValueError, spellnum.__functions.get_period_suffix, tuple())
...
class SuffixNominalCases(unittest.TestCase):
    ...
    def test_suffix_uniqueness(self):
        ...
        unique_suffix_count = len(set(spellnum.__functions.get_period_suffix(bi) for bi in range(-1, 1000)))
        self.assertEqual(expected, unique_suffix_count)
        
    def test_90(self):
        expected = 'nonagintillion'
        actual = spellnum.__functions.get_period_suffix(90)
        self.assertMultiLineEqual(expected, actual)
        
    def test_91(self):
        expected = 'unnonagintillion'
        actual = spellnum.__functions.get_period_suffix(91)
        self.assertMultiLineEqual(expected, actual)
        
    def test_92(self):
        expected = 'duononagintillion'
        actual = spellnum.__functions.get_period_suffix(92)
        self.assertMultiLineEqual(expected, actual)
        
    def test_93(self):
        expected = 'trenonagintillion'
        actual = spellnum.__functions.get_period_suffix(93)
        self.assertMultiLineEqual(expected, actual)
        
    def test_94(self):
        expected = 'quattuornonagintillion'
        actual = spellnum.__functions.get_period_suffix(94)
        self.assertMultiLineEqual(expected, actual)
        
    def test_95(self):
        expected = 'quinquanonagintillion'
        actual = spellnum.__functions.get_period_suffix(95)
        self.assertMultiLineEqual(expected, actual)
        
    def test_96(self):
        expected = 'senonagintillion'
        actual = spellnum.__functions.get_period_suffix(96)
        self.assertMultiLineEqual(expected, actual)
        
    def test_97(self):
        expected = 'septenonagintillion'
        actual = spellnum.__functions.get_period_suffix(97)
        self.assertMultiLineEqual(expected, actual)
        
    def test_98(self):
        expected = 'octononagintillion'
        actual = spellnum.__functions.get_period_suffix(98)
        self.assertMultiLineEqual(expected, actual)
        
    def test_99(self):
        expected = 'novenonagintillion'
        actual = spellnum.__functions.get_period_suffix(99)
        self.assertMultiLineEqual(expected, actual)
...
class SuffixExceptions(unittest.TestCase):
    ...
    def test_103_vs_300(self):
        ...
        """
        trescentillion = spellnum.__functions.get_period_suffix(103)
        trecentillion = spellnum.__functions.get_period_suffix(300)
